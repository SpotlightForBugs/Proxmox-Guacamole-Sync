#!/usr/bin/env python3
"""
Proxmox Guacamole Sync CLI using Cleo framework.
"""
...
class WebCommand(Command):
    ...
    def handle(self):
        ...
        port = self.option("port") or "8501"
        host = self.option("host") or "localhost"
...
class InteractiveCommand(Command):
    ...
    def handle(self):
        ...
        self.line("Proxmox Guacamole Sync - Interactive Mode")
        self.line("=" * 45)
...
def create_application():
    ...
    app = Application("guac-sync", "1.0.0")
